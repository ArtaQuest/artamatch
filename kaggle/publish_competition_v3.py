"""
publish_competition_v3.py — create the SECOND-EDITION competition (start year as an input), and nothing else.
...
def retire_old():
    st, b = call("UpdateCompetitionSettings", {
        ...
        "settings": {"competitionName": OLD_SLUG,
                     "title": "[SUPERSEDED] ArtaMatch Astrology: two birth dates only",
                     "briefDescription": f"Superseded by {SLUG}, the second edition, which adds the year the "
                                         f"relationship began as an input. Please enter that one.",
