"""comp_label-p1971.py — VERBATIM COPY of fit_nested.py for the label-p1971 competition entry (only the TAG
prefix differs; the corpus it runs on is built by comp_label-p1971_corpus.py). Original docstring:
...
TAG = "comp_label-p1971_" + TAG      # competition copy: outputs never collide with the shared fitter
