...
PAGE_FILES = ["index.html", "artamodel.html", "stack_iv_predictor.py", "stack_iv_deployed.json", "geo_lgbm_0.json", "geo_lgbm_1.json", "geo_lgbm_2.json", "sweshim.py", "predictor.py", "runner.py", "worked.py",
