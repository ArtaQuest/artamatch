 ...
 *
 * It also prints the number that decided the design — the rank correlation between ranking on the
 * traditional score alone and ranking on the old 60/30/10 blend. At ρ ≈ 0.95 the blend was moving
 * almost nothing while costing the page two unverifiable numbers, so it was removed.
 *
