...
TARGET_META = {
    ...
    "prosper2": {"name": "artamatch-prosper2-phasor", "target": "lasted_with_two_or_more_children",
                ...
                "positive": "toward lasting with children"},
    "sex_hadboy": {"name": "artamatch-hadboy-phasor", "target": "had_a_son",
                "says": "whether a couple like this, having children, had at least one son",
                "question": "did a couple like this, having children, have at least one son", "positive": "toward a son"},
    "sex_hadgirl": {"name": "artamatch-hadgirl-phasor", "target": "had_a_daughter",
                "says": "whether a couple like this, having children, had at least one daughter",
                "question": "did a couple like this, having children, have at least one daughter", "positive": "toward a daughter"},
    "sex_both": {"name": "artamatch-bothsex-phasor", "target": "children_of_both_sexes",
                "says": "whether a couple like this, having two or more children, had both sons and daughters",
                "question": "did a couple like this, having two or more children, have both sons and daughters", "positive": "toward both"},
    "sex_firstboy": {"name": "artamatch-firstboy-phasor", "target": "firstborn_a_son",
                "says": "whether a couple like this had a son first",
                "question": "did a couple like this have a son first", "positive": "toward a firstborn son"},
